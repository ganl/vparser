...
function ckstyle() {
    var ck = {
        ...
        cpt_lights: " ",
        cpt_share: " ",
        cpt_definition: "0x2a2a2a,0x56cbbd,100,10,0xFFFFFF,0xffffff,10,10,1,3,自动,12,MicrosoftYaHei|微软雅黑,0x2a2a2a,10,100,5,5,5,10,15,0x2a2a2a,0x2a2a2a,100,10,0xFFFFFF,0x56cbbd,10,10,1,3,12,MicrosoftYaHei|微软雅黑,28,0x000000,0,0,0,0",
        cpt_list: ckcpt()
    };
    return ck;
}
...
(function () {
    var CKobject = {
        ...
        browser: function () {
            var u = navigator.userAgent, rMsie = /(msie\s|trident.*rv:)([\w.]+)/, rFirefox = /(firefox)\/([\w.]+)/,
                rOpera = /(opera).+version\/([\w.]+)/, rChrome = /(chrome)\/([\w.]+)/,
                rSafari = /version\/([\w.]+).*(safari)/, rSafari2 = /(safari)\/([\w.]+)/,
                mozilla = /(mozilla)\/([\w.]+)/, mobile = /(mobile)\/([\w.]+)/;
            var c = u.toLowerCase();
        ...
        embedSWF: function (C, D, N, W, H, V, P) {
            ...
            this._A_ = V;
            this.getX();
            var u = "undefined", g = false, j = document, r = "http://www.macromedia.com/go/getflashplayer",
                t = '<a href="' + r + '" target="_blank">请点击�处下载安装最新的flash插件</a>',
                error = {w: "您的网页不符合w3c标准，无法显示�放器", f: "您没有安装flash插件，无法�放视频，" + t, v: "您的flash插件版本过低，无法�放视频，" + t},
        ...
        embedHTML5: function (C, P, W, H, V, A, S) {
            this._E_ = {c: C, p: P, w: W, h: H, v: V, s: S};
            this._A_ = A;
            this.getX();
        ...
        showHtml5: function () {
            var C = CKobject;
            var p = C._E_.p, a = C._E_.v, c = C._E_.c, b = false;
            var s = this._E_.v;
